...
matrix4x4 mathRotY (matrix4x4 matrix, float angle)
{
	...
	matrix4x4 rotMatrix;
	rotMatrix.row1[0] = cos(angle);			rotMatrix.row1[1] = 0;			rotMatrix.row1[2] = -sin(angle);		rotMatrix.row1[3] = 0;
	rotMatrix.row2[0] = 0;					rotMatrix.row2[1] = 1;			rotMatrix.row2[2] = 0;					rotMatrix.row2[3] = 0;
	rotMatrix.row3[0] = sin(angle);			rotMatrix.row3[1] = 0;			rotMatrix.row3[2] = cos(angle);			rotMatrix.row3[3] = 0;
